...
public class EnvioAlertas {
    ...
    public void verificarDados() throws Exception{
        try {
            ...
            //interrupcoes
            //String consultaUltimaInterrupcao = "SELECT i.totem, t.nome, i.motivo, i.horario FROM interrupcoes AS i JOIN totem AS t ON i.totem = t.idtotem ORDER BY i.horario DESC;";
                ...
                if (ultimoAlertaInterrupcao == null || horarioInterrupcao.isAfter(ultimoAlertaInterrupcao)) {
                    if (interrupcao != null && !interrupcao.isEmpty()) {
                        ...
                        if (horarioInterrupcao != null && nomeTotem != null && motivoInterrupcao != null && idTotemInterrupcao != null) {
                            ...
                            slack.sendSlackMessage("https://hooks.slack.com/services/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", jsonAlertaInterrupcao);
                        }
                    }
            ...
            // String consulta = "SELECT t.idtotem, t.nome AS nomeTotem, c.nome AS nomeComponente, tc.nome AS tipoComponente, r.valor, r.horario FROM totem AS t JOIN componente AS c ON t.idtotem = c.idcomponente JOIN tipoComponente AS tc ON tc.idtipoComponente = c.idcomponente JOIN registro AS r ON r.idregistro = c.idcomponente ORDER BY r.horario DESC;";
                        ...
                        case "CPU":
                            if (registro.getValor() < 80){
                                ...
                                *Detalhes:*
                                ...
                                sendSlackMessage("https://hooks.slack.com/services/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", json);
                                ...
                                *Caso o problema persista o totem será reiniciado!!!*
                                ...
                                :rotating_light: | Sobrecarga da CPU pode resultar em lentidão, travamentos e instabilidades do sistema.""".formatted(registro.getIdTotem(), registro.getNomeTotem(), registro.getValor(), registro.getHorario()));
                                    ...
                                    sendSlackMessage("https://hooks.slack.com/services/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", json);
